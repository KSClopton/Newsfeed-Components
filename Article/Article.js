...
const data = [
  ...
  {
    title: `Year of the Corona`,
    date: `May 6, 2020`,
    firstParagraph: `A new Virus`,
    secondParagraph:  `Corona Strikes Back`,
    thirdParagraph: `Return of the Bats`
  }
];
...
// Step 1: Create a function that creates a component. You will want your component to look like the template below: 
  ...
  const compCreator = (dataAttr) => {

    const {title , date, firstParagraph, secondParagraph, thirdParagraph } = dataAttr
...
let articles = document.querySelector('.articles')
  ...
  data.forEach((event) => {
    const article = compCreator(event)
